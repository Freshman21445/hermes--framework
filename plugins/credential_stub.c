// Stub for credential harvesting (disabled for testing).
#include "plugin.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static PluginInfo info = {
    .name = "credential_stub",
    .version = "1.0",
    .description = "Credential harvesting stub (disabled)"
};

int init(void) { return 0; }

int run(PluginContext* ctx, char** result) {
    fprintf(stderr, "Credential harvesting disabled (TEST_ONLY)\n");
